...
This is the code repository for [Podman for DevOps - Second Edition](https://www.packtpub.com/product/podman-for-devops/9781803248233?utm_source=github&utm_medium=repository&utm_campaign=9781803248233), published by Packt.
...
* Managing your containers and Kubernetes with Podman Desktop
...
| -------- | ------------------------------------ | ----------------------------------- |
| 1-14 | Podman 5 or later | Fedora 40 or later (preferred) or any other Linux distrubution |
| 6,7 | Buildah 1.x or later | Fedora 40 or later (preferred) or any other Linux distrubution |
| 9 | Skopeo 1.x or later | Fedora 40 or later (preferred) or any other Linux distrubution |
